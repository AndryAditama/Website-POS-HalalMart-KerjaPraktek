              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <?php
                    date_default_timezone_set('Asia/Jakarta');
                    $tgld = date('Y-m-d' ,strtotime('now'));
                    $laku = mysqli_query($koneksi, "SELECT SUM(hargatotal) AS hrg FROM tb_transaksi WHERE tanggal_transaksi LIKE '%".$tgld."%'");
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  ...
                  <?php
                    $pelanggan = mysqli_query($koneksi, "SELECT * FROM tb_member WHERE NOT id_member = '999999999999999'");
                    $jumlah_member = mysqli_num_rows($pelanggan);
                  ?>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo"$jumlah_member";?> Orang</h6>
