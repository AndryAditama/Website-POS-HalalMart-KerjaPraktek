...
<html>
    ...
    <body>
        ...
        <?php
                ...
                $hitungduit = mysqli_query($koneksi, "SELECT SUM(hargatotal) AS ht FROM tb_transaksi WHERE tanggal_transaksi LIKE '%".$tampungtgl."%'");
